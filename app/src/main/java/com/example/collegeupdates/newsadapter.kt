...
class newsadapter(var dataholder: ArrayList<Datamodel>) : RecyclerView.Adapter<newsadapter.Myviewholder>() {



    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Myviewholder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.single_row_design_news, parent, false)
